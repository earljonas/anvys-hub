...
const AddLocationCard = ({ onClick }) => {
    return (
        <button
            onClick={onClick}
            className="flex flex-col cursor-pointer items-center justify-center h-full min-h-[240px] w-full rounded-[var(--radius)] border-2 border-dashed border-[hsl(var(--border))] bg-[hsl(var(--muted))/30] hover:bg-[hsl(var(--muted))/50] hover:border-[hsl(var(--primary))/50] transition-all duration-200 group"
        >
